...
{'version': 5,
 'wave': {'bin_header': {'checksum': 5554,
          ...
          'wData': array([b'Mary', b'had', b'a', b'little', b'lamb'],
      dtype='|S6'),
          'wave_header': {'aModified': 0,
                          'bname': b'text0',
                          'botFullScale': 0.0,
...
{'version': 5,
 'wave': {'bin_header': {'checksum': 23021,
          ...
          'data_units': b'',
          'dimension_units': b'',
          'formula': b' PolarRadiusFunction(radiusData,1,0) * cos(PolarAngleFunction(angleData,3,1,2))',
          'labels': [[], [], [], []],
          'note': b'',
          'sIndices': array([], dtype=float64),
...
{'version': 5,
 'wave': {'bin_header': {'checksum': -9146,
          ...
          'data_units': b'',
          'dimension_units': b'',
          'formula': b' PolarRadiusFunction(radiusData,1,0) * sin(PolarAngleFunction(angleData,3,1,2))',
          'labels': [[], [], [], []],
          'note': b'shadowX=W_plrX5,appendRadius=radiusData,appendAngleData=angleData,angleDataUnits=2',
          'sIndices': array([], dtype=float64),
...
{'version': 5,
 'wave': {'bin_header': {'checksum': -5745,
          ...
          'data_units': b'',
          'dimension_units': b'',
          'formula': b' PolarRadiusFunction(radiusQ1,1,-40) * cos(PolarAngleFunction(angleQ1,2,2,2))',
          'labels': [[], [], [], []],
          'note': b'',
          'sIndices': array([], dtype=float64),
...
{'version': 5,
 'wave': {'bin_header': {'checksum': -16604,
          ...
          'data_units': b'',
          'dimension_units': b'',
          'formula': b' PolarRadiusFunction(radiusQ1,1,-40) * sin(PolarAngleFunction(angleQ1,2,2,2))',
          'labels': [[], [], [], []],
          'note': b'shadowX=W_plrX6,appendRadius=radiusQ1,appendAngleData=angleQ1,angleDataUnits=2',
          'sIndices': array([], dtype=float64),
...
{'variables': {'sysVars': {'K0': 0.0,
                           ...
                           'K8': 0.0,
                           'K9': 0.0},
               'userStrs': {b'u_dataBase': b';PolarGraph0:,...,useCircles=2,maxArcLine=6;',
                            b'u_dbBadStringChars': b',;=:',
                            b'u_dbCurrBag': b'PolarGraph1',
                            b'u_dbCurrContents': b',appendRadius=radiusQ1,...,useCircles=2,maxArcLine=6;',
...
{'variables': {'sysVars': {'K0': 0.0,
                           ...
                           'K8': 0.0,
                           'K9': 0.0},
               'userStrs': {b'u_colorList': b'black;blue;green;cyan;red;magenta;yellow;white;special',
                            b'u_debugStr': b'Turn Debugging On',
                            b'u_polAngleAxesWherePop': b'Off;Radius Start;Radius End;Radius Start and End;All Major Radii;At Listed Radii',
                            b'u_polAngleUnitsPop': b'deg;rad',
                            b'u_polLineStylePop': b'solid;dash 1;dash 2;dash 3;dash 4;dash 5;dash 6;dash 7;dash 8;dash 9;dash 10;dash 11;dash 12;dash 13;dash 14;dash 15;dash 16;dash 17;',
                            b'u_polOffOn': b'Off;On',
                            b'u_polRadAxesWherePop': b'  Off;  Angle Start;  Angle Middle;  Angle End;  Angle Start and End;  0;  90;  180; -90;  0, 90;  90, 180; -180, -90; -90, 0;  0, 180;  90, -90;  0, 90, 180, -90;  All Major Angles;  At Listed Angles',
                            b'u_polRotPop': b' -90;  0; +90; +180',
                            b'u_popup': b'',
                            b'u_prompt': b''},
               'userVars': {b'V_bottom': 232.0,
                            b'V_left': 1.0,
                            b'V_max': 2.4158518093414401,
                            ...
                            b'u_UniqWinNdx': 3.0,
                            b'u_angle0': 0.0,
                            b'u_angleRange': 6.2831853071795862,
                            b'u_debug': 0.0,
                            b'u_majorDelta': 0.0,
                            b'u_numPlaces': 0.0,
                            b'u_polAngle0': 0.26179938779914941,
                            b'u_polAngleRange': 1.0471975511965976,
                            b'u_polInnerRadius': -20.0,
                            b'u_polMajorAngleInc': 0.26179938779914941,
...
walk callback on ([b'root'], b'Packages', {...})
walk callback on ([b'root', b'Packages'], b'PolarGraphs', {...})
walk callback on ([b'root', b'Packages', b'PolarGraphs'], b'V_bottom', 232.0)
...
walk callback on ([b'root', b'Packages'], b'WMDataBase', {...})
...
walk callback on ([b'root'], b'radiusQ1', ...)
"""
